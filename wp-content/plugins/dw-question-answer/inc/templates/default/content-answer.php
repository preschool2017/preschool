        ...
        <header class="dwqa-header">
            ...
            <div class="dwqa-answer-author">
                ...
                <span class="dwqa-date">
                    <a href="#answer-<?php echo $answer_id ?>" title="<?php _e('Link to answer','dwqa') ?> #<?php echo $answer_id ?>"><?php echo get_the_date(); ?></a>
                </span>
                ...
                <div data-post="<?php echo $answer_id; ?>" data-nonce="<?php echo wp_create_nonce( '_dwqa_update_privacy_nonce' ); ?>" data-type="answer" class="dwqa-privacy">
                    ...
                    <span class="dwqa-current-privacy"><?php echo 'private' != get_post_status() ? '<i class="fa fa-globe"></i> ' . __('Public','dwqa') : '<i class="fa fa-lock"></i> ' . __('Private','dwqa'); ?></span>
