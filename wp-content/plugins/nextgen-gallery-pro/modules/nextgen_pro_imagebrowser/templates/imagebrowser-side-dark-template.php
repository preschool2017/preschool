<?php $this->start_element('nextgen_gallery.gallery_container', 'container', $displayed_gallery); ?>
	<div class='ngg-imagebrowser ngg-imagebrowser-side ngg-imagebrowser-side-dark' id='<?php echo $anchor; ?>' data-nextgen-gallery-id="<?php echo $displayed_gallery->id(); ?>">

    <h3><?php echo esc_attr($image->alttext); ?></h3>

    <div class='ngg-imagebrowser-image'>
    ...
    <div class='ngg-imagebrowser-nav'>
        ...
        <div class='ngg-imagebrowser-buttons'>
