...
<div id="ngg_free_form_container" style="display: none;">
    <h3><?php echo $i18n->headline; ?></h3>

        <a href="javascript:void(0)"
           id="ngg_free_button_cancel"
        ...
        <div id="nextgen_free_customer_name">
        ...
        <div id="nextgen_free_customer_email">
        ...
        <div id="nextgen_free_customer_address">
        ...
        <div id="ngg_free_buttons">
            <a href="javascript:void(0)"
               id="ngg_free_button_submit"
