jQuery(function($) {
    ...
    $('input[name="photocrati-nextgen_pro_mosaic[captions_enabled]"]')
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_mosaic_captions_animation'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_mosaic_captions_display_sharing'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_mosaic_captions_display_title'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_mosaic_captions_display_description'));
    $('input[name="photocrati-nextgen_pro_sidescroll[captions_enabled]"]')
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_sidescroll_captions_animation'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_sidescroll_captions_display_sharing'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_sidescroll_captions_display_title'))
        .nextgen_radio_toggle_tr('1', $('#tr_photocrati-nextgen_pro_sidescroll_captions_display_description'));
});
