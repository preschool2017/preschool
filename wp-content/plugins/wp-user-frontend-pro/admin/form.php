...
class WPUF_Admin_Form {
    ...
    function register_post_type() {
        ...
        register_post_type( 'wpuf_forms', array(
            ...
            'labels' => array(
                'name'               => __( '表单', 'wpuf' ),
                'singular_name'      => __( '表单', 'wpuf' ),
                'menu_name'          => __( '表单', 'wpuf' ),
                'add_new'            => __( '添加表单', 'wpuf' ),
                'add_new_item'       => __( '添加新表单', 'wpuf' ),
                'edit'               => __( '编辑', 'wpuf' ),
                'edit_item'          => __( '编辑表单', 'wpuf' ),
                'new_item'           => __( '新表单', 'wpuf' ),
                'view'               => __( '查看表单', 'wpuf' ),
                'view_item'          => __( '查看表单', 'wpuf' ),
                'search_items'       => __( '搜索表单', 'wpuf' ),
                'not_found'          => __( '没有找到表单', 'wpuf' ),
                'not_found_in_trash' => __( '回收站没有发现表单', 'wpuf' ),
                'parent'             => __( '上级表单', 'wpuf' ),
            ),
        ) );
