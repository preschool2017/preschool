...
class WPUF_form_element extends WPUF_Admin_Template_Post {
    ...
    public static function add_form_other_buttons() {
        ...
        <button class="button" data-name="ratings" data-type="action" title="<?php echo $title; ?>"><?php _e( 'Ratings', 'wpuf' ); ?></button>
    <?php
    }
            ...
            <div class="wpuf-taxonomies-holder">
                ...
                foreach ($custom_taxonomies as $tax_name => $tax) {
                    if ( strstr( $tax_name, 'pa_' ) && strpos( $tax_name, 'pa_' ) == 0 && in_array( 'product' , $tax->object_type ) && in_array( substr( $tax_name, 3 ) , $attr_name ) ) {
                        ...
                        ?>
                        <button class="wpuf-custom-tax-btn button <?php echo implode( ' ', $tax->object_type  )?>" style="<?php echo isset( $form_settings['post_type'] ) && !in_array( $form_settings['post_type'], $tax->object_type )?'display:none' : ''; ?>" data-name="taxonomy" data-type="<?php echo $tax_name; ?>" title="<?php _e( 'Click to add to the editor', 'wpuf' ); ?>"><?php echo $tax_name; ?></button>
                    <?php
                    }
    ...
    public static function date_field( $field_id, $label, $classname, $values = array() ) {
        ...
        <li class="custom-field custom_image">
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    <label><?php _e( 'Is Publish Time ? : ', 'wpuf' ); ?></label>
                    ...
                    <div class="wpuf-form-sub-fields">
                        <label>
                            ...
                            <?php _e( 'Set this as publish time input', 'wpuf' ); ?>
                        </label>
                    </div>
    ...
    public static function recaptcha( $field_id, $label, $classname, $values = array() ) {
        ...
        <li class="custom-field custom_html">
            ...
            <div class="wpuf-form-holder">
                ...
                <div class="wpuf-form-rows">
                    <label><?php _e( 'Enable noCaptcha', 'wpuf' ); ?></label>
     ...
     * @param array $values
     */
    public function ratings( $field_id, $label, $classname, $values = array() ) {
        ?>
        <li class="custom-field custom_html">
            <?php self::legend( $label, $values, $field_id ); ?>
