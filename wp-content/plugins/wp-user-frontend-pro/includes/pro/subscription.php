<?php
class WPUF_subscription_element extends WPUF_Subscription {
    ...
    public static function add_subscription_element( $sub_meta, $hidden_recurring_class, $hidden_trial_class, $obj ) {
        ...
        <tr valign="top">
            <th><label><?php _e( 'Enable Post Number Rollback', 'wpuf' ); ?></label></th>
            <td>
                <label>
                    ...
                    <?php _e( 'If enabled, number of posts will be restored if the post is deleted.', 'wpuf' ); ?>
                </label>
            </td>
        </tr>
    <?php
