...
class WPUF_Pro_Loader {
    ...
    public function __construct() {
        ...
        add_filter( 'wpuf_add_html', array( $this, 'wpuf_add_html_runner' ), 99, 4 );
    ...
    public function includes() {
        ...
        require_once dirname( __FILE__ ) . '/content-restriction.php';
     ...
     * show custom html
     */
    function wpuf_add_html_runner( $html, $value, $attr, $form_settings ) {
    ...
    function enqueue_scripts_styles( $hook ) {
        ...
        if ( wpuf_has_shortcode( 'wpuf_form', $post->ID )
            ...
            wp_enqueue_style('wpuf-rating-star-css',plugins_url('assets/css/css-stars.css',__FILE__));
            wp_enqueue_style('wpuf-rating-star-bs-css',plugins_url('assets/css/bootstrap-stars.css',__FILE__));
            wp_enqueue_script( 'wpuf-rating-js', plugins_url('assets/js/jquery.barrating.min.js',__FILE__), array('jquery') );
