...
<div class="container-fluid" id="my-box">
    <div class="row">
        <img src="<?php bloginfo('template_url');?>/topic/img/banner01.jpg" class="col-lg-12 col-xs-12"
...
<div class="container">
    <div class="row" style="text-align: center;">
        <div class="col-md-6 col-xs-12" style="margin-bottom: 20px;">
            <a href="http://www.preschool.net.cn/blog/2017/07/12/%e5%85%b3%e4%ba%8e%e4%b9%9d%e4%b8%89%e5%ad%a6%e7%a4%be%e5%b9%bc%e5%84%bf%e6%95%99%e8%82%b2%e4%b8%93%e5%ae%b6%e5%ba%93%e7%9a%84%e8%af%b4%e6%98%8e/"><img src="<?php bloginfo('template_url');?>/topic/img/banner02.jpg"
                                                                          class="img-responsive center-block"/></a>
        </div>
        <div class="col-md-6 col-xs-12">
            <a href="http://www.preschool.net.cn/blog/2017/07/12/%e5%85%b3%e4%ba%8e%e4%b8%ad%e5%9b%bd%e5%b9%bc%e5%84%bf%e6%95%99%e8%82%b2%e6%99%ba%e5%ba%93%e7%9a%84%e8%af%b4%e6%98%8e/"><img src="<?php bloginfo('template_url');?>/topic/img/banner03.jpg" class="img-responsive center-block"/></a>
        </div>
    </div>
    <!--tbanner end-->
    <div class="row" style="border: 1px solid #bbbabb;margin: 35px 15px 35px 15px;">
        <img src="<?php bloginfo('template_url');?>/topic/img/ptitle.png" class="img-responsive center-block"/>
    </div>
    <div class="row" style="margin:0 5px 20px 5px">
        <dl id="Jlist">
            <a href="http://www.preschool.net.cn/blog/2017/06/09/%e8%b5%b5%e5%bf%a0%e5%bf%83/" target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/3.jpg" class="img-responsive center-block" alt="专家"/>
            ...
            <a href="http://www.preschool.net.cn/blog/2017/07/28/%e9%a9%ac%e5%86%a0%e7%94%9f%ef%bc%9a%e5%b9%bc%e5%84%bf%e6%88%90%e9%95%bf%ef%bc%8c%e4%bb%8e%e9%a3%9f%e8%82%b2%e5%bc%80%e5%a7%8b/"
               target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/5.jpg" class="img-responsive center-block" alt="专家"/>

                    <div class="box">
                        <h3>马冠生</h3>

                        <p>北京大学医学部公共卫生学院营养与食品卫生系主任 研究员</p>
            ...
            <a href="http://www.preschool.net.cn/blog/2017/08/30/%e8%91%9b%e6%96%87%e5%bd%a4-%e7%8e%b0%e4%bb%bb%e9%a6%96%e9%83%bd%e5%8c%bb%e7%a7%91%e5%a4%a7%e5%ad%a6%e9%99%84%e5%b1%9e%e5%8c%97%e4%ba%ac%e5%90%8c%e4%bb%81%e5%8c%bb%e9%99%a2%e8%80%b3%e9%bc%bb%e5%92%bd/"
               target="_blank">
                <dd class="col-md-3 col-xs-6">
                    ...
                    <img src="<?php bloginfo('template_url');?>/topic/img/8.jpg" class="img-responsive center-block" alt="专家"/>
            ...
            <a href="http://www.preschool.net.cn/blog/2017/08/22/%e5%90%91%e8%8e%89%e4%b8%93%e8%ae%bf%ef%bd%9c%e6%95%8f%e5%84%bf%e6%88%90%e9%95%bf%ef%bc%8c%e9%a2%84%e9%98%b2%e4%b8%ba%e5%85%88/"
               target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/6.jpg" class="img-responsive center-block" alt="专家"/>

                    <div class="box">
                        <h3>向莉</h3>

                        <p>北京儿童医院过敏反应科主任、主任医师、副教授</p>
                    </div>
                </dd>
            </a>
            <a href="http://www.preschool.net.cn/blog/2017/06/09/933/" target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/9.jpg" class="img-responsive center-block" alt="专家"/>

                    <div class="box">
                        <h3>楚江亭</h3>

                        <p>博士生导师国内知名教育专家、著名教授</p>

                    </div>
                </dd>
            </a>
            <a href="http://www.preschool.net.cn/blog/2017/06/09/%e7%a8%8b%e5%85%89%e6%b3%89/" target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/11.jpg" class="img-responsive center-block" alt="专家"/>

                    <div class="box">
                        <h3>程光泉</h3>

                        <p>哲学博士，副教授，北师大哲学与社会学学院副院长、思想政治教育系主任、</p>
            ...
            <a href="http://www.preschool.net.cn/blog/2017/06/23/%e4%bd%99%e6%b8%85%e8%87%a3%e5%89%af%e6%95%99%e6%8e%88/"
               target="_blank">
                <dd class="col-md-3 col-xs-6">
                    <img src="<?php bloginfo('template_url');?>/topic/img/10.jpg" class="img-responsive center-block" alt="专家"/>
    ...
    <div class="row" id="tab">
        <div class="col-lg-12">
            <ul id="myTab" class="nav nav-pills" style="margin-left: 15px;">
                <li class="active"><a href="#education" data-toggle="tab">儿童教育</a></li>
                <li><a href="#Medical" data-toggle="tab">儿童医疗</a></li>
                <li><a href="#Nutrition" data-toggle="tab">儿童营养</a></li>
                <li><a href="#Law" data-toggle="tab">儿童法律</a></li>
                <li><a href="#Psychology" data-toggle="tab">儿童心理</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
...
<script>
    $(function () {
        ...
        time = setInterval(function () {
            $("#Jlist dd").children('.box').css("width", $("#Jlist dd img").width())
        }, 0)

        $('#Jlist dd').hover(function () {
            $(this).children('.box').stop(true, true).delay(100).animate({'top': 0, opacity: 0.7}, 300);
        }, function () {
            $(this).children('.box').stop(true, true).animate({'top': -382, opacity: 0}, 200);
        })

        //获取头部距离，自动适配
        var top_margin = $('#header').css('height');
        $('#my-box').css('margin-top',top_margin);
