                ...
                <div class="content">
                            ...
                            <div class="row">
                                ...
                                <div class="row hidden-md hidden-lg " style="text-align: center; padding: 0px;margin-top: 15px; margin-bottom: 25px;">
                                    <div class="col-md-12" style="padding: 0px;">
                                        <!-- <a style="display:inline-block;" href="http://ap.yoursclass.com/activity/index.html?id=258&st=1"><img src="/wp-content/themes/Grace/g-procurement/images/zrye1.jpg" alt=""></a> -->
                                        <a style="display:inline-block;" href="http://yc.preschool.net.cn/activity/index.html?id=240&st=1"><img src="/wp-content/themes/Grace/g-procurement/images/zrye13.jpg" alt=""></a>
                                    </div>
                                </div>
                            
                                <div class="row hidden-md hidden-lg"  style="padding:0px;text-align: center; margin-top: 15px;margin-bottom: 25px;">
                                    <div class="col-md-12" style="padding: 0px;">
                                        <a href="http://yc.preschool.net.cn/activity/index.html?id=246&st=2"><img src="/wp-content/themes/Grace/g-procurement/images/csrz.jpg" alt="" style="border:0px;"></a>
                                    </div>
                                ...
                                <div class="row hidden-md hidden-lg"  style="padding:0px;text-align: center; margin-top: 15px;margin-bottom: 25px;">
                                    <div class="col-md-12" style="padding: 0px;">
                                        <a href="http://yc.preschool.net.cn/activity/index.html?id=245&st=3"><img src="/wp-content/themes/Grace/g-procurement/images/mjhb.jpg" alt="" style="border:0px;"></a>
                                    </div>
                                    <!-- <div class="col-md-12" style="text-align: center; margin-top: -50px;">
                                        <a href="http://ap.yoursclass.com/activity/index.html?id=259&st=2" class="btn btn-primary col-md-5" style="margin-right:10px;">厂商入驻</a>
                                        <a href="http://ap.yoursclass.com/activity/index.html?id=257&st=3" class="btn btn-primary col-md-5">买家入驻</a>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            ?>
                                            <span class="cat-post current" data-paged="1" data-category="29" data-action="fa_load_postlist"  data-total="<?php echo $total_29;?>">商品列表</span>
                                            <span class="cat-post " data-paged="1" data-category="28" data-action="fa_load_postlist"  data-total="<?php echo $total_28;?>">厂家列表</span>
                                       </div>
                                   </div>
                               </div>
                            </div>
                    ...
                    //echo "pages:".$the_query->max_num_pages;
                        ...
                        <div class="accc col-md-3" style="padding: 0px;">
                            ...
                            <div class="row hidden-xs hidden-sm " style="text-align: center; padding: 0px; margin-bottom: 25px;">
                                    <div class="col-md-12" style="padding: 0px;">
                                        <a href="http://yc.preschool.net.cn/activity/index.html?id=240&st=1"><img src="/wp-content/themes/Grace/g-procurement/images/zrye13.jpg" alt=""></a>
                                    </div>
