...
class suxingme_postlist extends WP_Widget {
    ...
    function widget($args, $instance) {
		...
		echo $before_widget;
        if($instance['title'] == '专家专栏')
        {
            echo $before_title.$title.'<a style="margin-left:120px;" href="http://www.preschool.net.cn/blog/category/%e9%a6%96%e9%a1%b5/z-j/">更多</a>'.$after_title;
        }else{
